...
const ProjectModal = dynamic(
  () => import("@/components/ProjectModal").then((mod) => mod.ProjectModal),
  { ssr: false },
);

const TICKER =
  "PYTHON · REACT · NODE.JS · JAVA · C++ · MONGODB · AWS · DOCKER · POSTGRESQL · NEXT.JS · TYPESCRIPT · ";

const SERVICES = [
  {
    title: "Web Application Development",
    desc: "Frontend to backend — we own the whole thing.",
  ...
  },
  {
    ...
    desc: "iOS and Android. Native when it matters, cross-platform when it doesn't.",
  ...
  },
  {
    ...
    desc: "Fast, documented, and built so the next developer doesn't hate us.",
  ...
  },
  {
    ...
    desc: "Working product in weeks. Real users. Real feedback.",
    stack: "Rapid Prototyping · Full Stack",
    color: "#B8F2C8",
    href: "/services/startup-mvp-development",
  },
  {
    title: "Tech Consulting",
    desc: "We tell you what we'd actually build if it were our money.",
    stack: "Architecture · Code Review",
    color: "#7B2FFF",
    href: "/services/technology-consulting",
  },
  {
    title: "Legacy Modernization",
    desc: "Old systems that work fine — except when they don't.",
    stack: "Migration · Refactoring · Documentation",
    color: "#FF4D6D",
...
const STEPS = [
  {
    n: 1,
    title: "Discovery",
    desc: "One honest call. We ask the right questions and actually listen to the answers.",
  },
  {
    n: 2,
    title: "Proposal",
    desc: "Scope, timeline, and price in plain writing. No hidden fees discovered after you say yes.",
  },
  {
    n: 3,
    title: "Build",
    desc: "Weekly demos. You see the product grow. Your feedback shapes every sprint.",
  },
  {
    n: 4,
    title: "Handover",
    desc: "Full docs, clean repo, and we're still reachable after you pay the last invoice.",
  },
];
...
const VALUES = [
  {
    title: "Direct access",
    desc: "You talk to developers, not account managers.",
    color: "#7B2FFF",
  },
  {
    title: "Honest pricing",
    desc: "We quote what it actually costs.",
    color: "#FF4D6D",
  },
  {
    title: "We say no",
    desc: "We turn down work we can't do well.",
    color: "#FFB830",
  },
  {
    title: "Startup speed",
    desc: "Small team means fast decisions.",
    color: "#B8F2C8",
  },
];
...
const TECH = [
  ...
  { name: "JavaScript", variant: "amber" },
  { name: "TypeScript", variant: "coral" },
  { name: "React", variant: "sage" },
  { name: "Next.js", variant: "violet-outline" },
  { name: "Node.js", variant: "violet" },
  { name: "Java", variant: "coral" },
  { name: "C", variant: "amber" },
  { name: "C++", variant: "sage" },
  { name: "PostgreSQL", variant: "coral-outline" },
  { name: "MongoDB", variant: "sage" },
  { name: "AWS", variant: "amber" },
  { name: "Docker", variant: "violet" },
  { name: "Git", variant: "coral" },
  { name: "REST APIs", variant: "amber-outline" },
  { name: "GraphQL", variant: "violet" },
];

function tagClass(v: string) {
  switch (v) {
    case "violet":
      return "bg-[#7B2FFF] text-white";
    case "coral":
      return "bg-[#FF4D6D] text-white";
    case "amber":
      return "bg-[#FFB830] text-[#1C1A26]";
    case "sage":
      return "bg-[#B8F2C8] text-[#1C1A26]";
    case "violet-outline":
      return "border-2 border-[#7B2FFF] text-[#7B2FFF]";
    case "coral-outline":
      return "border-2 border-[#FF4D6D] text-[#FF4D6D]";
    case "amber-outline":
      return "border-2 border-[#FFB830] text-[#1C1A26]";
    default:
      return "bg-[#7B2FFF] text-white";
  }
}
  ...
  return (
    <div style={{ perspective: 200 }}>
      <div className="cube-3d">
        ...
        <div
          className="face f-top"
          style={{ background: color, filter: "brightness(1.3)" }}
        />
        <div
          className="face f-right"
          style={{ background: color, filter: "brightness(0.7)" }}
        />
      </div>
    </div>
  );
      ...
      <div className="sphere-3d w-full h-full">
        ...
        {Array.from({ length: rings }).map((_, i) => (
          <div
            ...
            className="ring"
            style={{
              transform: `rotateX(90deg) rotateY(${(180 / rings) * i}deg)`,
            }}
          />
        ))}
      </div>
    ...
    <button
      ...
      <div
        ...
        <div
          ...
          <span className="font-display font-semibold text-white text-[18px]">
            Quick look →
          </span>
        </div>
      ...
      <div className="p-6">
        ...
        <p className="font-body text-[15px] text-[#1C1A26]/70 leading-relaxed mb-3">
          {p.desc}
        </p>
        <Link
          href={`/work/${p.slug}`}
    ...
    <div
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildFaqSchema(HOME_FAQS)),
        }}
      />
      ...
      <section
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 80% 40%, rgba(123,47,255,0.18), transparent 60%), radial-gradient(ellipse at 20% 80%, rgba(255,77,109,0.12), transparent 55%)",
          }}
        />
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-10 pt-44 pb-32 flex-1 grid md:grid-cols-[55fr_45fr] gap-10 items-center">
          <div>
            <div className="eyebrow text-coral mb-8">
              SOFTWARE · CONSULTING · STARTUPS
            </div>
            <h1
              className="font-display font-extrabold text-near-white leading-[0.95] mb-8"
            ...
            <p
              className="font-body text-near-white/70 max-w-xl mb-10"
              style={{ fontSize: 17, lineHeight: 1.75 }}>
              Neural Mesh Tech is a software development company that builds
              custom web applications, mobile apps, scalable APIs, startup MVPs,
              and modernization projects. We take fewer clients so we can do
              better work.
            </p>
            <div className="flex flex-wrap gap-4">
              <a href="#work" className="btn-violet">
                See Our Work
              </a>
              <a href="#contact" className="btn-coral-outline">
                Talk to Us →
              </a>
            </div>
          </div>
          <div className="hidden md:block relative h-[450px] w-full z-10 select-none">
            ...
            <div
              id="hero-card-web"
              className="absolute top-[8%] right-[5%] p-3.5 rounded-xl bg-[#131124]/80 border border-white/10 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.5)] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-[#FF4D6D]/40"
              style={{ zIndex: 2 }}>
            ...
            <div
              id="hero-card-mobile"
              className="absolute top-[42%] left-[-8%] p-3.5 rounded-xl bg-[#131124]/80 border border-white/10 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.5)] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-[#FFB830]/40"
              style={{ zIndex: 2 }}>
            ...
            <div
              id="hero-card-backend"
              className="absolute bottom-[10%] right-[2%] p-3.5 rounded-xl bg-[#131124]/80 border border-white/10 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.5)] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-[#7B2FFF]/40"
              style={{ zIndex: 2 }}>
        ...
        {/* Ticker */}
        <div
          className="relative border-t border-violet/30"
          style={{ backgroundColor: "#0a0813" }}>
              ...
              {visible.map((p, i) => {
                ...
                return (
                  <ProjectCard
                    ...
                    big={big}
                    className={
                      big ? "md:col-span-2 md:row-span-2 md:min-h-[560px]" : ""
                    }
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {SERVICES.map((s) => (
              <div
                ...
                <h3 className="font-display font-semibold text-[20px] mb-3 text-near-white">
                  {s.title}
                </h3>
                <p className="font-body text-[15px] text-near-white/65 leading-relaxed mb-5">
                  {s.desc}
                </p>
                ...
                <Link
                  href={s.href}
                  className="mt-5 inline-flex eyebrow text-near-white hover:text-coral">
                  Learn more →
                </Link>
              </div>
            ))}
      ...
      <section
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6">
            <div
              className="hidden md:block absolute top-12 left-[12%] right-[12%] h-px border-t-2 border-dashed"
              style={{ borderColor: "#7B2FFF", opacity: 0.4 }}
            />
            {STEPS.map((s) => (
              <div key={s.n} className="reveal relative pt-2">
                <div
                  className="font-display font-extrabold absolute -top-4 -left-2 select-none pointer-events-none"
                  style={{
                    fontSize: 96,
                ...
                <div className="relative">
                  ...
                  <p className="font-body text-[15px] text-[#1C1A26]/70 leading-relaxed">
                    {s.desc}
                  </p>
                </div>
              </div>
      ...
      <section
        ...
        <div className="relative max-w-4xl mx-auto px-6 md:px-10 text-center">
          <blockquote
            className="font-display italic font-medium reveal mb-16"
            style={{ fontSize: "clamp(28px, 3.5vw, 40px)", lineHeight: 1.3 }}>
            &ldquo;We&apos;re not the biggest option. We&apos;re the one that
            picks up the phone and cares how the code ends up.&rdquo;
          </blockquote>
          <div className="grid sm:grid-cols-2 gap-10 text-left reveal">
            {VALUES.map((v) => (
              <div key={v.title} className="flex gap-4">
                <div
                  className="shrink-0 mt-2 w-0 h-0"
                  style={{
                ...
                />
                <div>
                  <h4 className="font-display font-semibold text-[20px] mb-1">
                    {v.title}
                  </h4>
                  <p className="font-body text-[15px] text-near-white/65">
                    {v.desc}
                  </p>
                </div>
              </div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-10">
          <div className="reveal mb-12">
            ...
            <h2
              className="font-display font-bold leading-[1.02]"
              style={{ fontSize: "clamp(36px, 5vw, 52px)" }}>
              Common questions about Neural Mesh Tech.
            </h2>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-10 grid md:grid-cols-2 gap-16">
          <div className="reveal">
            ...
            <ul className="space-y-4 mb-10">
              {[
                ...
                <li
                  key={r.t}
                  className="flex items-center gap-3 font-body text-[16px] text-near-white/80">
                  <span
            ...
            <a
              href="mailto:hello@neuralmeshs.com"
              className="font-mono text-coral text-[18px] md:text-[22px] break-all hover:underline">
          ...
          {sendSuccess ? (
            <div className="space-y-6 p-6 rounded-xl border border-emerald-500/20 bg-[#161422] text-center w-full max-w-lg">
              ...
              <h3 className="font-display font-semibold text-[20px] text-near-white">
                Message Transmitted
              </h3>
            ...
            <div className="space-y-6 p-8 rounded-xl border border-violet/20 bg-[#161422] text-center w-full max-w-lg">
              ...
              <h3 className="font-display font-semibold text-[17px] text-near-white">
                {sendProgressStage}
              </h3>
              <p className="font-mono text-[11px] text-near-white/40">
                Transmission progress: {sendProgress}%
              </p>
            ...
            <form
              className="reveal space-y-5 w-full max-w-lg"
