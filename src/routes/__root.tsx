...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { name: "description", content: "A small, focused software and IT consulting studio. We take fewer clients so we can do better work." },
        ...
        { property: "og:description", content: "Software that ships. Built with intent, not a template." },
        ...
        { name: "twitter:description", content: "A small, focused software and IT consulting studio. We take fewer clients so we can do better work." },
