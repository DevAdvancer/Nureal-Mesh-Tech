...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { name: "application-name", content: "Neural Mesh" },
        { name: "apple-mobile-web-app-title", content: "Neural Mesh" },
        ...
        { name: "description", content: "Neural Mesh (Neural Mesh Technologies / Neural Mesh Tech) is a focused custom software development and IT consulting studio. We build web apps, mobile apps, APIs, MVPs, and modernize legacy systems. Software that ships — built with intent, not a template." },
        {
          name: "keywords",
          content:
            "neural mesh, neural mesh tech, neural mesh technologies, nueral mesh tech, nueral mesh technologies, neuralmeshs, neural mesh software, neural mesh studio, neural mesh consulting, neural mesh tech inc, neural mesh technologies inc, neuralmeshs.com, neural mesh it, software studio, software development, it consulting, custom software, web app development, mobile app development, api development, mvp development, legacy modernization, tech consulting, software that ships, neural mesh tech company",
        },
        { name: "subject", content: "Neural Mesh — Software Development & IT Consulting" },
        { name: "abstract", content: "Neural Mesh (Neural Mesh Technologies) — small, focused software studio building web apps, mobile apps, APIs, MVPs and modernizing legacy systems." },
        { name: "topic", content: "Software Development, IT Consulting, Web Apps, Mobile Apps, APIs, MVPs" },
        { name: "summary", content: "Neural Mesh is the official website of Neural Mesh Technologies — a focused software and IT consulting studio." },
        ...
        { name: "author", content: "Neural Mesh" },
        { name: "designer", content: "Neural Mesh" },
        { name: "owner", content: "Neural Mesh" },
        { name: "publisher", content: "Neural Mesh" },
        { name: "copyright", content: "© 2024 Neural Mesh" },
        { name: "url", content: "https://neuralmeshs.com/" },
        { name: "identifier-URL", content: "https://neuralmeshs.com/" },
        { name: "directory", content: "submission" },
        { name: "pagename", content: "Neural Mesh" },
        ...
        { property: "og:description", content: "Neural Mesh (Neural Mesh Technologies / Neural Mesh Tech) — a focused software and IT consulting studio. Web apps, mobile apps, APIs, MVPs, modernization." },
        ...
        { name: "twitter:description", content: "Neural Mesh (Neural Mesh Technologies / Neural Mesh Tech) — software & IT consulting studio. Web apps, mobile apps, APIs, MVPs, modernization." },
        { name: "twitter:image", content: "https://neuralmeshs.com/og-image.png" },
        { name: "twitter:image:alt", content: "Neural Mesh — Software that ships." },
        ...
        // AI / LLM explicit
        { name: "ai-content-declaration", content: "Original content authored by Neural Mesh." },
        { name: "ai-training", content: "allowed" },
        { name: "citation", content: "Neural Mesh — https://neuralmeshs.com/" },
      ],
      links: [
        ...
        { rel: "mask-icon", href: "/favicon.png", color: "#7B2FFF" },
            ...
            "@graph": [
              {
                ...
                description:
                  "Neural Mesh (Neural Mesh Technologies / Neural Mesh Tech) — a focused software development and IT consulting studio. Web apps, mobile apps, APIs, MVPs, legacy modernization.",
                inLanguage: "en-US",
              ...
              },
              {
                ...
                description:
                  "Neural Mesh (Neural Mesh Technologies / Neural Mesh Tech) — small, focused software development and IT consulting studio.",
                foundingDate: "2024",
                ...
                keywords:
                  "neural mesh, neural mesh tech, neural mesh technologies, nueral mesh tech, nueral mesh technologies, neural mesh software, neural mesh studio, software development, it consulting",
              },
            ],
          }),
        },
